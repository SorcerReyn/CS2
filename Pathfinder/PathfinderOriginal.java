...
public class PathfinderOriginal
{
	...
	public static void enableAnimation() { PathfinderOriginal.animationEnabled = true; }
	public static void disableAnimation() { PathfinderOriginal.animationEnabled = false; }
	public static void setFrameRate(double fps) { PathfinderOriginal.frameRate = frameRate; }
	                                 ...
	                                 int height, int width)
	{
		...
		if (PathfinderOriginal.animationEnabled)
		{
			printAndWait(maze, height, width, "Searching...", PathfinderOriginal.frameRate);
		}
		...
		if (visited[currentRow][currentCol] == 'e')
		{
			if (PathfinderOriginal.animationEnabled)
			{
				for (int i = 0; i < 3; i++)
				{
					...
					printAndWait(maze, height, width, "Hooray!", PathfinderOriginal.frameRate);
	...
	public static void main(String [] args) throws IOException
	{
		...
		char [][] maze = readMaze("maze1.txt");
		PathfinderOriginal.enableAnimation();

		// Go!!
		if (PathfinderOriginal.solveMaze(maze))
